...
extension UIImage {
    ...
    func pngBase64String(options: Data.Base64EncodingOptions = .lineLength64Characters) -> String? {
        return pngData()?.base64EncodedString(options: options)
    }

    func jpegBase64String(compressionQuality: CGFloat, options: Data.Base64EncodingOptions = .lineLength64Characters) -> String? {
        return jpegData(compressionQuality: compressionQuality)?.base64EncodedString(options: options)
    }
}
